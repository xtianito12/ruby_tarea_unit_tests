...
class FarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post farms_url, params: { farm: { bought_on: @farm.bought_on, grower_id: @farm.grower_id, name: @farm.name } }
    end
  ...
  test "should update farm" do
    patch farm_url(@farm), params: { farm: { bought_on: @farm.bought_on, grower_id: @farm.grower_id, name: @farm.name } }
